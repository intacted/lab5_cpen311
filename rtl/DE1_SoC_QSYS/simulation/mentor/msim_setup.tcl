...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"              -work limiter_pipeline                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                -work limiter_pipeline                          
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                  -work sdram_s1_rsp_width_adapter                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"              -work sdram_s1_rsp_width_adapter                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"             -work sdram_s1_rsp_width_adapter                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work rsp_mux_002                               
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_rsp_mux_002.sv"   -work rsp_mux_002                               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work rsp_mux_001                               
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_rsp_mux_001.sv"   -work rsp_mux_001                               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work rsp_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_rsp_mux.sv"       -work rsp_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_rsp_demux_016.sv" -work rsp_demux_016                             
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_rsp_demux_015.sv" -work rsp_demux_015                             
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_rsp_demux_010.sv" -work rsp_demux_010                             
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_rsp_demux.sv"     -work rsp_demux                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_mux_010                               
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_cmd_mux_010.sv"   -work cmd_mux_010                               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_mux_006                               
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_cmd_mux_006.sv"   -work cmd_mux_006                               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_cmd_mux.sv"       -work cmd_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_cmd_demux_002.sv" -work cmd_demux_002                             
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_cmd_demux_001.sv" -work cmd_demux_001                             
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_cmd_demux.sv"     -work cmd_demux                                 
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                -work cpu_data_master_limiter                   
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                 -work cpu_data_master_limiter                   
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                         -work cpu_data_master_limiter                   
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                -work cpu_data_master_limiter                   
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_router_013.sv"    -work router_013                                
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_router_009.sv"    -work router_009                                
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_router_003.sv"    -work router_003                                
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_router_002.sv"    -work router_002                                
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_router_001.sv"    -work router_001                                
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_mm_interconnect_0_router.sv"        -work router                                    
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/alt_vipitc131_IS2Vid.sv"                         -work alt_vip_itc_0                             
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/alt_vipitc131_IS2Vid_mode_banks.sv"              -work alt_vip_itc_0                             
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/DE1_SoC_QSYS_irq_mapper.sv"                      -work irq_mapper                                
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L limiter_pipeline -L crosser -L sdram_s1_rsp_width_adapter -L rsp_mux_002 -L rsp_mux_001 -L rsp_mux -L rsp_demux_016 -L rsp_demux_015 -L rsp_demux_010 -L rsp_demux -L cmd_mux_010 -L cmd_mux_006 -L cmd_mux -L cmd_demux_002 -L cmd_demux_001 -L cmd_demux -L sdram_s1_burst_adapter -L cpu_data_master_limiter -L router_013 -L router_009 -L router_003 -L router_002 -L router_001 -L router -L jtag_uart_avalon_jtag_slave_agent_rsp_fifo -L jtag_uart_avalon_jtag_slave_agent -L cpu_data_master_agent -L jtag_uart_avalon_jtag_slave_translator -L cpu_data_master_translator -L vga_clk -L alt_vip_vfr_0 -L alt_vip_itc_0 -L fifo_used -L OUT_PAUSE -L EMPTY -L DATA_FREGEN -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_0 -L vga -L timer -L sysid_qsys -L signal_selector -L sdram -L pll -L mouse_pos -L modulation_selector -L lfsr_val -L lfsr_clk_interrupt_gen -L keyboard_keys -L key -L jtag_uart -L dds_increment -L cpu -L audio_sel -L audio -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
